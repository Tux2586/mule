...
public class ArtifactUrlClassification {
   ...
   *        {@link ClassLoader}
   * @param serviceUrlClassifications for each plugin discovered a list of {@link ServiceUrlClassification} that defines the artifact
   *                              that would be loaded by the service {@link ClassLoader}
   * @param pluginUrlClassifications for each plugin discovered a list of {@link PluginUrlClassification} that defines the artifact
   *                              that would be loaded by the plugin {@link ClassLoader}
