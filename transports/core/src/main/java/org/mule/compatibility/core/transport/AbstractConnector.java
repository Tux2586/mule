...
public abstract class AbstractConnector extends AbstractAnnotatedObject implements Connector, WorkListener
{
   ...
   protected void configureDispatcherPool()
   {
    ...
    protected MessageDispatcher borrowDispatcher(OutboundEndpoint endpoint) throws MuleException
    {
        if (!isStarted())
        {
            throw new LifecycleException(TransportCoreMessages.lifecycleErrorCannotUseConnector(getName(),
        ...
        {
            throw new IllegalArgumentException(TransportCoreMessages.connectorSchemeIncompatibleWithEndpointScheme(
        ...
        {
            throw new ConnectorException(TransportCoreMessages.connectorCausedError(), this, ex);
        }
        finally
        {
            try
    ...
    public List<Transformer> getDefaultInboundTransformers(ImmutableEndpoint endpoint)
    {
        ...
        return TransportTransformerUtils.getDefaultInboundTransformers(serviceDescriptor, endpoint);
    }
    ...
    public List<Transformer> getDefaultResponseTransformers(ImmutableEndpoint endpoint)
    {
        ...
        return TransportTransformerUtils.getDefaultResponseTransformers(serviceDescriptor, endpoint);
    }
    ...
    public List<Transformer> getDefaultOutboundTransformers(ImmutableEndpoint endpoint)
    {
        ...
        return TransportTransformerUtils.getDefaultOutboundTransformers(serviceDescriptor, endpoint);
    }
    ...
    {
        return new EndpointReplyToHandler(endpoint.getMuleContext());
    }
    ...
    final public <T> T getTransactionalResource(ImmutableEndpoint endpoint) throws MuleException
    {
        ...
        if (currentTx != null)
        {
            ...
            else
            {
                ...
                {
                    throw new TransactionException(TransportCoreMessages.createStaticMessage("Endpoint is transactional but transaction does not support it"));
                }
    ...
    {
        throw new MuleRuntimeException(TransportCoreMessages.createStaticMessage("Operation not supported by dispatcher"));
    }
    ...
    protected void handleWorkException(WorkEvent event, String type)
    {
        ...
        else
        {
            muleContext.getExceptionListener().handleException(
                new MuleRuntimeException(TransportCoreMessages.connectorCausedError(this.getName()), e));
        }
    }
    ...
    public void initialiseFromUrl(EndpointURI endpointUri) throws InitialisationException
    {
        ...
        {
            throw new InitialisationException(TransportCoreMessages.schemeNotCompatibleWithConnector(
        ...
        setName(new TransportObjectNameHelper(muleContext).getConnectorName(this));
        // initialise();
    }
