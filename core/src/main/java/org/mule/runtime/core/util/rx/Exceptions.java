...
public class Exceptions
{
     ...
     * {@link CheckedConsumer} using {@link reactor.core.Exceptions#propagate(Throwable)}. Useful when using existing methods which throw
     ...
     * @return consumer that adapts {@link CheckedConsumer} and {@link reactor.core.Exceptions#propagate(Throwable)}'s checked exceptions
     ...
     * {@link CheckedBiConsumer} using {@link reactor.core.Exceptions#propagate(Throwable)}. Useful when using existing methods which throw
     * checked exceptions to avoid try/catch blocks and improve readability.
     *
     * @param checkedBiConsumer the biconsumer that throws a chedked exception
     * @param <T> the type of the first argument to the operation
     * @param <U> the type of the second argument to the operation
     * @return biconsumer that adapts {@link CheckedBiConsumer} and {@link reactor.core.Exceptions#propagate(Throwable)}'s checked exceptions
     * @see reactor.core.Exceptions#propagate(Throwable)
     */
     ...
     * {@link CheckedFunction} using {@link reactor.core.Exceptions#propagate(Throwable)}. Useful when using existing methods which throw
     * checked exceptions to avoid try/catch blocks and improve readability.
     *
     ...
     * @return function that adapts {@link CheckedFunction} and {@link reactor.core.Exceptions#propagate(Throwable)}'s checked exceptions
     * @see reactor.core.Exceptions#propagate(Throwable)
     */
     ...
     * {@link CheckedBiFunction} using {@link reactor.core.Exceptions#propagate(Throwable)}. Useful when using existing methods which throw
     * checked exceptions to avoid try/catch blocks and improve readability.
     *
     ...
     * @param <R> the type of the result of the function
     * @return bifunction that adapts {@link CheckedBiFunction} and {@link reactor.core.Exceptions#propagate(Throwable)}'s checked exceptions
     * @see reactor.core.Exceptions#propagate(Throwable)
     */
     ...
     * {@link CheckedPredicate} using {@link reactor.core.Exceptions#propagate(Throwable)}. Useful when using existing methods which throw
     * checked exceptions to avoid try/catch blocks and improve readability.
     *
     ...
     * @return predicate that adapts {@link CheckedPredicate} and {@link reactor.core.Exceptions#propagate(Throwable)}'s checked exceptions
     * @see reactor.core.Exceptions#propagate(Throwable)
     */
     ...
     * {@link CheckedBiPredicate} using {@link reactor.core.Exceptions#propagate(Throwable)}. Useful when using existing methods which throw
     * checked exceptions to avoid try/catch blocks and improve readability.
     *
     * @param checkedBiPredicate  the bipredicate that throws a checked exception
     * @param <T> the type of the first argument to the predicate
     * @param <U> the type of the second argument the predicate
     * @return bipredicate that adapts {@link CheckedBiPredicate} and {@link reactor.core.Exceptions#propagate(Throwable)}'s checked exceptions
     * @see reactor.core.Exceptions#propagate(Throwable)
     */
